  ...
  return (
    <div>
      ...
      <section className="flex items-center justify-center bg-[url('/inicio-img.png')] bg-cover bg-top w-full h-[272px] lg:bg-none lg:flex-row">
        ...
        <hr className='border-2 h-96 border-black mr-32 mt-[522px] mob:hidden'/>
      ...
      <p className='text-black font-bold w-[464px] leading-5 mob:hidden mt-24 ml-28 text-center'>A Hortomática foi projetada para ser simples e eficiente. Possuindo um formato de uma “caixa”, onde a terra é posta, onde por baixo há uma base impermeável, onde ficam os componentes que tornam a Hortomática automatizada. Com sensores que monitoram constantemente o nível de umidade, garantindo que a planta receba a quantidade ideal de água. </p>
      ...
      <section className='bg-purple-700 text-purple-700 w-full h-5 mt-0 lg:mt-44 lg:bg-green-400 lg:text-green-400 lg:h-11'>
            <p></p>
      </section>
